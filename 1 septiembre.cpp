        ...
        case'O':
            do{
                ...
                case'T':
                	...
                	cout<<"Burbuja"<<endl;
                    cout<<"Numero de operaciones: "<<B.burbuja()<<endl;
                    cout<<"numero de operaciones estimadas"<<((ta*(ta-1))/2)<<endl;   
                    ...
                    cout<<"numero de operaciones estimadas: "<< y<<endl; 
                     ...
                     cout<<"Shell"<<endl;
                    cout<<"Numero de operaciones: "<<B.shell()<<endl;
                    cout<<"numero de operaciones estimadas: "<<sqrt(pow(ta,(3)))<<endl;
